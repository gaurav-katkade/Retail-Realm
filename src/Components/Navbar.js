...
const Navbar=()=>{
 ...
 return <Nav>
    ...
    <li ><NavLink to="/Product" className='navbar-link'>Product</NavLink></li>
    <li ><NavLink to="/contact" className='navbar-link'>Contact</NavLink></li>
    <li className=' cart-trolley--link'>
        <NavLink to="/cart"><BsFillCartCheckFill className='cart-trolley'/>
            <div className='cart-total--item'>50</div>
        </NavLink> 
    </li>
    </ul>
